...
import com.example.parking.api.dataclasses.ReservationJson
import com.example.parking.api.interfaces.ReservationRequests
...
class ReservationAPI(private val retrofitAdminAuth: Retrofit, private val retrofitUserAuth: Retrofit) {

    private val apiAdminAuth: ReservationRequests = retrofitAdminAuth.create(ReservationRequests::class.java)
    private val apiUserAuth: ReservationRequests = retrofitUserAuth.create(ReservationRequests::class.java)

    private var currentAuthRole: String = "admin"
    private var currentApi: ReservationRequests = apiAdminAuth
